...
** =elgot=
2024-02 =eglot= has been incorporated into the emacs29 base, and you don't need
to use-package?

2022-12-20 =elgot= is or soon will be supported directly in EMACS base, so it's
seems like it's making a large splash in the community.  For using javascript I
also needed to do ~snap install typescript-language-server~ in order to get the
javascript supported.

I was having trouble getting good intergration w/ the bash-language-server, but
    it turns out that was just because I didn't have shellcheck installed, which
    provides alot of the functionality.
...
feature, you can also use eshell within a tramp docker session.  This is part of
emacs now.

** Tree sitter packages

   Tree sitter has been incorporated into emacs, but the languages have not
   been. This [[https://www.masteringemacs.org/article/how-to-get-started-tree-sitter][Getting started guide]] describes adding language grammers like:
...
;     (tsx "https://github.com/tree-sitter/tree-sitter-typescript" "master" "tsx/src")
    ...
    Treesiter is built in now, but I need to setup the proper modes for that package.
