...
This example was copied from https://github.com/hrs/dotfiles.  Which is pretty terrific.

This is my emacs configuration file, it's the strategy from the [[https://github.com/hrs/dotfiles][dotfiles repo]]
and I used that as my template.  I also needed to modify the init.el script:

#+BEGIN_EXAMPLE
;; I have this symbolically linked to here.
;; .emacs.d/init.el
...
From [[http://xiaohanyu.me/oh-my-emacs/modules/ome-javascript.html#js3-mode][OME]] a javascript setup.
...
There seems to be a bad issue with the some of the variables in org-mode that
haven't been properly addressed.  So, I need to add these additonal regular
expressions to get this to work.

I want to publish all my org-mode notes into a single html location, and I'd
like that to work recursively.  I've found these notes online: [[http://orgmode.org/worg/org-tutorials/org-publish-html-tutorial.html][tutorial]]. And I
also found these [[https://github.com/fniessen/org-html-themes][great themes]].  In the end, I hope to eliminate most of the
other MD style publishing for this more basic setup.
...
#+BEGIN_SRC emacs-lisp
  ...
  '(("org-notes"
   :base-directory "~/qjhart.github.io/org/"
   :base-extension "org"
   :publishing-directory "~/qjhart.github.io/htdocs/"
   :recursive t
...
#+RESULTS:
| org-notes  | :base-directory | ~/qjhart.github.io/org/ | :base-extension | org  | :publishing-directory | ~/qjhart.github.io/htdocs/ | :recursive | t    | :publishing-function | org-html-publish-to-html | :headline-levels |   4 | :auto-preamble        | t              |            |   |                      |                        |
| org-static | :base-directory | ~/qjhart.github.io/org/ | :base-extension | css\ | js\                   | png\                       | jpg\       | gif\ | pdf\                 | mp3\                     | ogg\             | swf | :publishing-directory | ~/public_html/ | :recursive | t | :publishing-function | org-publish-attachment |
| org        | :components     | (org-notes org-static)  |                 |      |                       |                            |            |      |                      |                          |                  |     |                       |                |            |   |                      |                        |
...
Store my org files in =~/org=, should be linked to =qjhart.github.io/org= define
...
#+RESULTS:
| l | Today I Learned... | entry      | (file+olp+datetree ~/org/til.org) | * %?      |           |            |    |   |
| f | Finished book      | table-line | (file ~/org/books-read.org)       |           | %^{Title} | %^{Author} | %u |   |
| r | Reading            | checkitem  | (file ~/org/to-read.org)          |           |           |            |    |   |
| t | Todo               | entry      | (file org-index-file)             | * TODO %? |           |            |    |   |
...
Snippets in =~/.emacs/snippets=, which should be default always want =yasnippet=
enabled.
